...
/*!
  Passes through, or blocks trigger messages based on a string-encoded sequence of "0" and "1"
  passed to the "sequence" method. "1110" will result in four passes and one block. "111000" will
  result in three passes and three blocks. Any character other than "1" and "0" will be ignored. So
  you can add delimiters for readability, like this: "1110|1000|1010|1111". "1" means pass, "0"
  means block.
*/
...
public:
    ...
    ControlTriggerFilter sequence(string seqArg)
    {
        gen()->sequence(seqArg);
        return *this;
    };
