...
//! On trigger, outputs a value beginning at start, and incrementing by step toward end, then back
//! again.
// Currently it steps up and down. In the future an option may be added to snap back to the
// beginning.
