...
namespace Tonic_ {
    ...
    public:
        ...
        // Pass in a pointer to a TonicFloat to return a value. Some generators may not care about
        // value.
...
public:
    ControlGenerator(Tonic_::ControlGenerator_* cGen = new Tonic_::ControlGenerator_)
        : TonicSmartPointer<Tonic_::ControlGenerator_>(cGen)
    {
    }
...
#define TONIC_MAKE_CTRL_GEN_SETTERS(                                                              \
    generatorClassName, methodNameInGenerator, methodNameInGenerator_)                            \
                                                                                                  \
