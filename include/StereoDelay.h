...
namespace Tonic_ {
    ...
    public:
        ...
        void initialize(
            float leftDelayArg, float rightDelayArg, float maxDelayLeft, float maxDelayRight);

        void setFeedback(Generator arg) { fbkGen_ = arg; };

        void setDelayTimeLeft(Generator arg) { delayTimeGen_[0] = arg; };

        void setDelayTimeRight(Generator arg) { delayTimeGen_[1] = arg; };
    };
...
public:
    StereoDelay(
        float leftDelay, float rightDelay, float maxDelayLeft = -1, float maxDelayRight = -1);
