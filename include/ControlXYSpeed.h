...
/*!
  Given a point described by an x and y coordinate, calculate the speed that the point is moving.
  This is designed for mouse/finger speed, but could potentially have other uses.
*/
