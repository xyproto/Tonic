...
class ControlRecorder
    : public TemplatedControlConditioner<ControlRecorder, Tonic_::ControlRecorder_> {

public:
    enum Mode { RECORD, PLAY, STOP };
...
namespace Tonic_ {
    ...
    inline void ControlRecorder_::computeOutput(const SynthesisContext_& context)
    {
        ...
        case ControlRecorder::PLAY:
            ...
            //        printf("ControlRecorder_::computeOutput playing back sample: %i of %lu. Value
