...
namespace Tonic_ {
    ...
    protected:
        ...
        enum ADSRState { NEUTRAL, ATTACK, SUSTAIN, DECAY, RELEASE };
    ...
    public:
        ...
        //! Controls whether the envelope picks up from current position or zero when re-triggered
...
/*!
  Classic ADSR envlelope. Non-zero trigger values correspond to key down. Trigger values of zero
  correspond to keyup. Time values are rounded up to the nearest buffer size. Time values are in
  milliseconds.
*/
