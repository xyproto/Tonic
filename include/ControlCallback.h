...
/*!
  Pass a lambda function to a controlgenerator. That function will be called when the input
  ControlGenerator sends a "triggered" message. Constructor takes two arguments -- the synth that
  owns the ControlCallback, and a lambda function
*/

class ControlCallback
    : public TemplatedControlConditioner<ControlCallback, Tonic_::ControlCallback_> {
