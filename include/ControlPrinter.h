...
/*
  A controlconditioner which can be used to print the value of its input. You can set an optional
  format string to customize the message using printf-style formatting, with exactly one %f
  placeholder. For example: "Current bpm is %f.";
*/

class ControlPrinter
    : public TemplatedControlConditioner<Tonic::ControlPrinter, Tonic_::ControlPrinter_> {
