...
public:
    void setLeft(ControlGenerator gen) { this->gen()->setLeft(gen); }

    void setRight(ControlGenerator gen) { this->gen()->setRight(gen); }
};
...
namespace Tonic_ {
    ...
    protected:
        inline bool satisfiesCondition(TonicFloat l, TonicFloat r) { return l == r; }
    };
}
...
class ControlGreaterOrEqual
    : public TemplatedControlComparisonOperator<Tonic_::ControlGreaterOrEqual_> {
};
