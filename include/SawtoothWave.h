...
namespace Tonic_ {
    ...
    // Generator_ class to generate hard-edge rising saw, falling saw, triangle, or any angle
    // in-between.
    ...
    public:
        ...
        void setFrequencyGenerator(Generator gen) { freqGen_ = gen; }

        void setSlopeGenerator(Generator gen) { slopeGen_ = gen; }
    };
...
/*!
    Not anti-aliased, so really best as an LFO. Can be used as an audio sawtooth oscillator in a
   pinch or if you don't mind some aliasing distortion.
*/
