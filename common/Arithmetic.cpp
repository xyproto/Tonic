...
namespace Tonic_ {
    ...
    Adder_::Adder_() { workSpace_.resize(kSynthesisBlockSize, 1, 0); }
    ...
    Subtractor_::Subtractor_() { workSpace_.resize(kSynthesisBlockSize, 1, 0); }
    ...
    Multiplier_::Multiplier_() { workSpace_.resize(kSynthesisBlockSize, 1, 0); }
    ...
    Divider_::Divider_() { workSpace_.resize(kSynthesisBlockSize, 1, 0); }
