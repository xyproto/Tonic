...
string ControlParameter::getName() { return gen()->getName(); }
...
string ControlParameter::getDisplayName() { return gen()->getDisplayName(); }
...
TonicFloat ControlParameter::getValue() { return gen()->getValue(); }
...
TonicFloat ControlParameter::getMin() { return gen()->getMin(); }
...
TonicFloat ControlParameter::getMax() { return gen()->getMax(); }
...
ControlParameterType ControlParameter::getParameterType() { return gen()->getType(); }
...
bool ControlParameter::getIsLogarithmic() { return gen()->getIsLogarithmic(); }
...
TonicFloat ControlParameter::getNormalizedValue() { return gen()->getNormalizedValue(); }
